      ...
      <el-table :data="comments">
        ...
        <el-table-column label="操作" width="120">
          <template slot-scope="scope">
            ...
            >打开评论</el-button>
            <el-button v-else type="danger" size="mini" @click="toggle(scope.row)">关闭评论</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
      <el-pagination style="margin-top:20px" background layout="prev, pager, next" :total="total"></el-pagination>
    </el-card>
  </div>
</template>
